...
{
    public partial class WebSocketClientOptionsControl : ClientOptionsControl
    {
        public WebSocketClientOptionsControl()
        {
            InitializeComponent();
        }
        ...
        {
            var options = (QpWebSocketClientOptions)DataContext;

            ClientOptionsControlUtils.LinkControl(lblUrl, txtUrl);
            ClientOptionsControlUtils.BindString(txtUrl, () => options.Url, t => options.Url = t);
